...
export function EventItem({sendTextToUser, createNamedGroup, text, leng, oneEvent, deleteEvent, updateEvent, setEvents, botId}){
  ...
  const buttonsSectionUse = [
    <ModalMonitorEvent sendTextToUser={sendTextToUser} createNamedGroup={createNamedGroup} text={text} leng={leng} oneEvent={oneEvent} botId={botId}/>,
  ]
